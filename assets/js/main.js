function main() {
    ...
    */
    ...
    /* ===== Click Listeners ===== */
    // We need to create a function for this: so it allow us to handle click on the dynamically edited content
    ...
    function hideEdit() {
        document.querySelectorAll(".alimentsList").forEach((item) => {
            ...
            item.parentNode.parentNode.querySelector('.edit-alim-actions').classList.add('none')
    ...
    function showEdit() {
        document.querySelectorAll(".alimentsList").forEach((item) => {
            ...
            item.parentNode.parentNode.querySelector('.edit-alim-actions').classList.remove('none')
            item.querySelectorAll('.delete-aliment').forEach( item => {
